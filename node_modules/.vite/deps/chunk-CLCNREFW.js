...
// node_modules/robotevents/out/util/ratelimit.js
var require_ratelimit = __commonJS({
  "node_modules/robotevents/out/util/ratelimit.js"(exports) {
    "use strict";
    ...
    function ready() {
      if (exports.CURRENT-- > 0) {
        ...
        return new Promise((resolve) => setInterval(resolve, (60 - (/* @__PURE__ */ new Date()).getSeconds()) * 1e3));
      }
    }
    exports.ready = ready;
...
// node_modules/robotevents/out/util/authentication.js
var require_authentication = __commonJS({
  "node_modules/robotevents/out/util/authentication.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ok = exports.setBearer = exports.BEARER = void 0;
    exports.BEARER = "";
    ...
    function ok() {
      return exports.BEARER !== "";
    }
    exports.ok = ok;
  }
});

// node_modules/robotevents/out/util/request.js
var require_request = __commonJS({
  "node_modules/robotevents/out/util/request.js"(exports) {
    "use strict";
...
// node_modules/robotevents/out/v1/skills.js
var require_skills = __commonJS({
  "node_modules/robotevents/out/v1/skills.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var request_1 = require_request();
    async function getSkillsLeaderboard(season, options, maxAge) {
      let results = await (0, request_1.requestSingle)(`/api/seasons/${season}/skills`, { grade_level: options.grade_level, post_season: options.post_season }, maxAge);
      if (options.region) {
        results = results.filter((spot) => spot.team.eventRegion === options.region);
      }
      return results;
    }
...
//# sourceMappingURL=chunk-CLCNREFW.js.map
